...
const (
	...
	LEASE_MOVEOUT_REMINDER_SMS_BODY = `Hi {{tenant_name}}, your lease for {{unit_name}} ends in {{days_remaining}} day(s) on {{move_out_date}}. Please contact your landlord if you'd like to renew or extend your lease, or prepare for move-out.`
