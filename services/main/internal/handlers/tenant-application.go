...
type CreateTenantApplicationRequest struct {
	...
	EmployerType                   string    `json:"employer_type"                     validate:"required"                                                      example:"PRINCIPAL"                            description:"Employer type of the applicant"`
...
type UpdateTenantApplicationRequest struct {
	...
	EmployerType                   *string    `json:"employer_type,omitempty"                     validate:"omitempty"                                                                  example:"PRINCIPAL"                            description:"Employer type of the applicant"`
