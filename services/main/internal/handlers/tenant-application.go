...
type UpdateTenantApplicationRequest struct {
	...
	DesiredMoveInDate              lib.Optional[time.Time]  `json:"desired_move_in_date,omitempty"              validate:"omitempty"                                                                  swaggertype:"string"                          description:"Desired move in date"`
	StayDurationFrequency          lib.Optional[string]     `json:"stay_duration_frequency,omitempty"           validate:"omitempty"                                                                  swaggertype:"string"                          description:"Stay duration frequency"`
	StayDuration                   lib.Optional[int64]      `json:"stay_duration,omitempty"                     validate:"omitempty"                                                                  swaggertype:"integer"                         description:"Stay duration"`
	PaymentFrequency               lib.Optional[string]     `json:"payment_frequency,omitempty"                 validate:"omitempty"                                                                  swaggertype:"string"                          description:"Payment frequency"`
	InitialDepositFee              lib.Optional[int64]      `json:"initial_deposit_fee,omitempty"               validate:"omitempty"                                                                  swaggertype:"integer"                         description:"Initial deposit fee"`
	...
	SecurityDepositFee             lib.Optional[int64]      `json:"security_deposit_fee,omitempty"              validate:"omitempty"                                                                  swaggertype:"integer"                         description:"Security deposit fee"`
	...
	OtherNames                     lib.Optional[string]     `json:"other_names,omitempty"                       validate:"omitempty"                                                                  swaggertype:"string"                          description:"Other names of the applicant"`
	Email                          lib.Optional[string]     `json:"email,omitempty"                             validate:"omitempty"                                                                  swaggertype:"string"                          description:"Email address of the applicant"`
	ProfilePhotoUrl                lib.Optional[string]     `json:"profile_photo_url,omitempty"                 validate:"omitempty"                                                                  swaggertype:"string"                          description:"Profile photo URL"`
	...
	IDFrontUrl                     lib.Optional[string]     `json:"id_front_url,omitempty"                      validate:"omitempty"                                                                  swaggertype:"string"                          description:"ID front image URL"`
	IDBackUrl                      lib.Optional[string]     `json:"id_back_url,omitempty"                       validate:"omitempty"                                                                  swaggertype:"string"                          description:"ID back image URL"`
	PreviousLandlordName           lib.Optional[string]     `json:"previous_landlord_name,omitempty"            validate:"omitempty"                                                                  swaggertype:"string"                          description:"Previous landlord name"`
	PreviousLandlordPhone          lib.Optional[string]     `json:"previous_landlord_phone,omitempty"           validate:"omitempty"                                                                  swaggertype:"string"                          description:"Previous landlord phone"`
	PreviousTenancyPeriod          lib.Optional[string]     `json:"previous_tenancy_period,omitempty"           validate:"omitempty"                                                                  swaggertype:"string"                          description:"Previous tenancy period"`
	ProofOfIncomeUrl               lib.Optional[string]     `json:"proof_of_income_url,omitempty"               validate:"omitempty"                                                                  swaggertype:"string"                          description:"Proof of income URL"`
	LeaseAgreementDocumentMode     lib.Optional[string]     `json:"lease_agreement_document_mode,omitempty"     validate:"omitempty"                                                                  swaggertype:"string"                          description:"Lease agreement document mode"`
	LeaseAgreementDocumentUrl      lib.Optional[string]     `json:"lease_agreement_document_url,omitempty"      validate:"omitempty"                                                                  swaggertype:"string"                          description:"Lease agreement document URL"`
	LeaseAgreementDocumentID       lib.Optional[string]     `json:"lease_agreement_document_id,omitempty"       validate:"omitempty"                                                                  swaggertype:"string"                          description:"Lease agreement document ID"`
	LeaseAgreementDocumentStatus   lib.Optional[string]     `json:"lease_agreement_document_status,omitempty"   validate:"omitempty"                                                                  swaggertype:"string"                          description:"Lease agreement document status"`
}
