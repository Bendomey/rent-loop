...
type UpdateTenantApplicationRequest struct {
	...
	SecurityDepositPaymentId                        *string    `json:"security_deposit_payment_id,omitempty"                            validate:"omitempty"                                                                  example:"576695af-6e14-4c78-8f92-f4aedb94d07a" description:"Security deposit payment ID"`
	OtherNames                                      *string    `json:"other_names,omitempty"                                            validate:"omitempty"                                                                  example:"Michael"                              description:"Other names of the applicant"`
	Email                                           *string    `json:"email,omitempty"                                                  validate:"omitempty,email"                                                            example:"john.doe@example.com"                 description:"Email address of the applicant"`
	...
	LeaseAgreementDocumentPropertyManagerSignedById *string    `json:"lease_agreement_document_property_manager_signed_by_id,omitempty" validate:"omitempty,uuid"                                                             example:"576695af-6e14-4c78-8f92-f4aedb94d07a" description:"Lease agreement document property manager signed by ID"`
	LeaseAgreementDocumentPropertyManagerSignedAt   *time.Time `json:"lease_agreement_document_property_manager_signed_at,omitempty"    validate:"omitempty"                                                                  example:"2023-01-01T00:00:00Z"                 description:"Lease agreement document property manager signed at"`
	LeaseAgreementDocumentTenantSignedAt            *time.Time `json:"lease_agreement_document_tenant_signed_at,omitempty"              validate:"omitempty"                                                                  example:"2023-01-01T00:00:00Z"                 description:"Lease agreement document tenant signed at"`
}
