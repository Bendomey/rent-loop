...
func NewLeaseTerminationHandler(
	appCtx pkg.AppContext,
	service services.LeaseTerminationService,
	invoiceService services.InvoiceService,
) LeaseTerminationHandler {
...
type UpdateLeaseTerminationRequest struct {
	...
	DocumentMode     lib.Optional[string] `json:"document_mode,omitempty"                                                                                                          description:"MANUAL or ONLINE"                                 swaggertype:"string"`
	DocumentUrl      lib.Optional[string] `json:"document_url,omitempty"                                                                                                           description:"External termination agreement URL (MANUAL mode)" swaggertype:"string"`
	DocumentId       lib.Optional[string] `json:"document_id,omitempty"                                                                                                            description:"Library document ID (ONLINE mode)"                swaggertype:"string"`
	LeaseChecklistID lib.Optional[string] `json:"lease_checklist_id,omitempty"                                                                                                     description:"Move-out checklist ID"                            swaggertype:"string"`
}
