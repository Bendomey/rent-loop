...
type AddLineItemRequest struct {
	...
	Category    string          `json:"category"           validate:"required,oneof=RENT SECURITY_DEPOSIT AGENCY_FEE VAT UTILITY MAINTENANCE_CHARGE DAMAGE_CHARGE EARLY_TERMINATION_FEE OTHER MAINTENANCE_FEE SAAS_FEE BOOKING_FEE" example:"OTHER"        description:"Category of line item"`
...
type UpdateLineItemRequest struct {
	...
	Category    *string         `json:"category,omitempty"     validate:"omitempty,oneof=RENT SECURITY_DEPOSIT AGENCY_FEE VAT UTILITY MAINTENANCE_CHARGE DAMAGE_CHARGE EARLY_TERMINATION_FEE OTHER MAINTENANCE_FEE SAAS_FEE BOOKING_FEE" example:"OTHER"        description:"Category of line item"`
