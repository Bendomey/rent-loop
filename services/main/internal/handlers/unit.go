...
type UpdateUnitRequest struct {
	...
	Description         lib.Optional[string]  `json:"description"           validate:"omitempty"                                                          example:"Spacious apartment with balcony"      description:"Optional description of the unit. Send null to clear it; omit to leave it unchanged"                 swaggertype:"string"`
	Images              *[]string             `json:"images"                validate:"omitempty,dive,url"                                                 example:"http://www.images/unit101.jpg"        description:"List of image URLs for the unit"`
	Tags                *[]string             `json:"tags"                  validate:"omitempty,dive"                                                     example:"apartment,balcony"                    description:"Tags associated with the unit"`
	...
	Area                lib.Optional[float64] `json:"area"                  validate:"omitempty"                                                          example:"120.5"                                description:"Area of the unit in square feet or square meters. Send null to clear it; omit to leave it unchanged" swaggertype:"number"`
	...
	PropertyBlockID     *string               `json:"property_block_id"     validate:"omitempty,uuid4"                                                    example:"a8098c1a-f86e-11da-bd1a-00112444be1e" description:"Moves the unit to a different block within the same property"`
}
