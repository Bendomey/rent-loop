...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/admin/clients/{client_id}/properties/{property_id}/leases:bulk-onboard": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Bulk onboard request body (max 10 entries)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.BulkOnboardLeasesRequest"
                        }
                    }
                ],
                "responses": {
                    "204": {
                        "description": "Bulk onboard successful"
                    },
                    "400": {
                        "description": "Validation or business rule error (e.g. UnitNoLongerAvailable, PeriodsPaidInvalid)",
                        "schema": {
                            "$ref": "#/definitions/lib.HTTPError"
                        }
                    },
    ...
    "definitions": {
        ...
        "handlers.BulkOnboardLeaseEntryRequest": {
            "type": "object",
            "required": [
                "current_address",
                "date_of_birth",
        ...
        "handlers.BulkOnboardLeasesRequest": {
            "type": "object",
            "required": [
                "entries"
            ],
            "properties": {
                "entries": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/handlers.BulkOnboardLeaseEntryRequest"
                    }
                }
            }
        },
