...
| Small apartment block with 8 units     | 1          | 1        | 8     | GH₵ 80       |
| Two apartment complexes, 30 units each | 2          | 4        | 60    | GH₵ 600      |
| Large hostel with 120 rooms            | 1          | 6        | 120   | GH₵ 960      |

Your first 5 units are free. Once you go beyond that, you start paying for your units. Up to 100 units, you pay GH₵ 10 per unit per month. Beyond 100, that drops to GH₵ 8 per unit per month. For portfolios above 200 units, reach out for a custom plan.
...
Ama owns a complex in Tema with two buildings. Building A has 12 apartments and Building B has 18 apartments. She creates one **Multi** property, adds two blocks (Block A and Block B), and adds units to each. Her 30 total units bill at GH₵ 10 per unit per month.
...
A hostel operator has 150 rooms across 5 floors. One **Multi** property, five blocks (one per floor), 30 units per floor. At 150 units total, the portfolio falls in the 101–200 range, so all 150 units bill at GH₵ 8 — GH₵ 1,200 per month. Rentloop applies the right rate automatically.
