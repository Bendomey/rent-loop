	...
	return (
		<MarketingPage current="blog">
			...
			>
				...
				<Figure tight={false}>
					<img
						src="/images/blog/best-property-management-app-in-ghana-og.jpg"
						alt="A smiling woman standing in front of a modern two-storey house under a red-to-blue sky"
						width={1200}
						height={630}
						fetchPriority="high"
						style={{
