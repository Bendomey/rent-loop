		...
		<div className="bg-rl-black rounded-t-3xl px-4 pt-10 pb-6 text-white md:px-14 md:pt-16 md:pb-8">
			...
			<div className="font-rl-sans mx-auto flex max-w-[1280px] flex-col gap-4 pt-6 text-[13px] text-white/45 md:flex-row md:items-center md:justify-between md:pt-7">
				...
				<div className="flex items-center gap-4">
					<a href="https://www.instagram.com/rentloop_app" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/45 transition-colors hover:text-white/80">
						<svg fill="currentColor" viewBox="0 0 24 24" className="size-[18px]">
					...
					<a href="https://www.tiktok.com/@rentekloop_app1" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-white/45 transition-colors hover:text-white/80">
						<svg fill="currentColor" viewBox="0 0 24 24" className="size-[18px]">
							<path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.16 8.16 0 004.77 1.53V6.77a4.85 4.85 0 01-1-.08z" />
						</svg>
					</a>
					<a href="https://www.facebook.com/rentloop" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/45 transition-colors hover:text-white/80">
						<svg fill="currentColor" viewBox="0 0 24 24" className="size-[18px]">
							<path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
						</svg>
					</a>
					<a href="https://x.com/rentloopapp" target="_blank" rel="noopener noreferrer" aria-label="X" className="text-white/45 transition-colors hover:text-white/80">
						<svg fill="currentColor" viewBox="0 0 24 24" className="size-[18px]">
							<path d="M13.6823 10.6218L20.2391 3H18.6854L12.9921 9.61788L8.44486 3H3.2002L10.0765 13.0074L3.2002 21H4.75404L10.7663 14.0113L15.5685 21H20.8131L13.6819 10.6218H13.6823ZM11.5541 13.0956L10.8574 12.0991L5.31391 4.16971H7.70053L12.1742 10.5689L12.8709 11.5655L18.6861 19.8835H16.2995L11.5541 13.096V13.0956Z" />
						</svg>
					</a>
					<a href="https://wa.me/233201080802" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-white/45 transition-colors hover:text-white/80">
						<svg fill="currentColor" viewBox="0 0 24 24" className="size-[18px]">
