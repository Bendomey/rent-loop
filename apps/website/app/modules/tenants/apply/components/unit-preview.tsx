...
import { getPropertyUnitStatusColor, getPropertyUnitStatusLabel } from '~/lib/properties.utils'
				...
				<div className="space-y-4 rounded-lg border border-slate-100 bg-slate-50 p-5">
					...
					<div className="space-y-3 text-sm">
						...
						<div className="flex items-center justify-between rounded-lg bg-white p-3">
							...
							<span className={`inline-flex items-center rounded-full ${getPropertyUnitStatusColor(unit?.status)} px-3 py-1 text-xs font-medium`}>			
