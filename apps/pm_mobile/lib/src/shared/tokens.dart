...
abstract final class RLTokens {
  ...
  static const double tabbarH   = 84; // tab bar height incl. home-indicator safe area
  ...
  static const double textLabel    = 10.5; // eyebrows, section labels (mono 500 uppercase)
