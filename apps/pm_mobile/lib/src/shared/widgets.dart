...
class RLMiniBars extends StatelessWidget {
  const RLMiniBars({
    ...
    this.height = 44,
    this.color = RLTokens.crimson,
    this.trackColor = RLTokens.crimsonTint2,
  });
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                trailing != null ? trailing! : const SizedBox(width: 38 + 12),
              ],
            ),
          ),
          Container(
            height: 1,
            color: dark ? Colors.white.withAlpha(20) : RLTokens.hairlineSoft,
          ),
        ],
      ),
    );
...
class RLIconBtn extends StatelessWidget {
  const RLIconBtn({
    ...
    this.onTap,
    this.badge,
    this.bg = RLTokens.surface,
    this.iconColor = RLTokens.ink,
  });
