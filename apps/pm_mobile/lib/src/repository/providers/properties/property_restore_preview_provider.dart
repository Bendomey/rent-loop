...
part 'property_restore_preview_provider.g.dart';

@riverpod
Future<PropertyRestorePreviewModel> propertyRestorePreview(
  PropertyRestorePreviewRef ref,
  String propertyId,
) async {
  ...
  return ref
      ...
      .getPropertyRestorePreview(clientId: clientId, propertyId: propertyId);
}
