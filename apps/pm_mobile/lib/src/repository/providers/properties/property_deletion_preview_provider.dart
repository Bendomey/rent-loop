...
part 'property_deletion_preview_provider.g.dart';

@riverpod
Future<PropertyDeletionPreviewModel> propertyDeletionPreview(
  PropertyDeletionPreviewRef ref,
  String propertyId,
) async {
  ...
  return ref
      ...
      .getPropertyDeletionPreview(clientId: clientId, propertyId: propertyId);
}
