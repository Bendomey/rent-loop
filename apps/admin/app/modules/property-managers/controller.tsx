import { Plus, RotateCw, ToggleLeft, Users } from 'lucide-react'
...
const filters: Array<Filter> = [
	{
		...
		value: {
			...
			urlParam: 'status',
			defaultValues: [
				{ value: 'ClientApplication.Status.Approved', label: 'Approved' },
			],
		},
	},
	{
		...
		<div className="flex w-full flex-col gap-2">
			...
			<div className="flex flex-wrap items-center justify-between gap-4">
				<div className="flex items-center gap-2 text-sm">
					<SearchInput placeholder="Search property managers…" />
				</div>
				<div className="flex items-center justify-end gap-2">
					<Link to="/property-managers/new">
						<Button
							variant="default"
							size="sm"
