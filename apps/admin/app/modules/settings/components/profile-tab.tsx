...
import { comingSoon, SettingsPanel, SettingsRow } from './settings-ui'
			...
			<SettingsPanel caption="Profile photo">
				<div className="flex flex-col items-start gap-5 sm:flex-row sm:items-center">
					<div className="relative shrink-0">
						...
						<button
							type="button"
							onClick={comingSoon('Profile photo uploads')}
					...
					<div className="flex-1">
						...
						<div className="mt-3.5 flex flex-wrap gap-2.5">
							<Button size="sm" onClick={comingSoon('Profile photo uploads')}>
								Upload photo
							</Button>
							<Button
								variant="outline"
