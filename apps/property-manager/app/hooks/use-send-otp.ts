...
// 	const sendOtp = (opts: { channel: 'SMS' | 'EMAIL'; phone?: string; email?: string }) => {
// 		if (opts.channel === 'SMS') {
// 			const formattedPhone = formatPhoneWithCountryCode(opts.phone, '+233', 9)
...
// 			if (!opts.email || !emailRegex.test(opts.email)) {
// 				toast.error('Invalid email address')
// 				return
// 			}

// 			mutate(
// 				{ channel: ['EMAIL'], email: opts.email },
// 				{
// 					onSuccess: () => {
