				...
				<div className="grid grid-cols-3 gap-3 sm:grid-cols-4 md:grid-cols-5">
					...
					{canAddMore && !disabled ? (
						<button
							type="button"
							className={cn(
								'flex aspect-square cursor-pointer flex-col items-center justify-center gap-1 rounded-sm border-2 border-dashed border-gray-300 bg-gray-50 transition-colors hover:border-gray-400 hover:bg-gray-100 dark:bg-zinc-900',
							)}
