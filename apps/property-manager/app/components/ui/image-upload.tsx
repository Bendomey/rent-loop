					...
					<>
						...
						{!disabled && !hideDismissIcon ? (
							<button
								...
								className="border-border bg-background text-foreground hover:bg-muted absolute -top-0.5 -right-0.5 z-10 rounded-full border p-1 shadow-sm transition-colors"
