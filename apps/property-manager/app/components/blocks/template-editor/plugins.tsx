...
export function Plugins({ maxLength }: Props) {
	...
	return (
		<div className="relative">
			...
			<div className="grid h-[calc(100vh-190px)] min-h-72 grid-cols-12 gap-4 bg-zinc-100 dark:bg-zinc-900 md:h-[calc(100vh-150px)]">
				<div className="col-span-12 flex h-full items-center justify-center md:col-span-9 md:pt-10">
					<div className="h-full w-full rounded bg-white dark:bg-zinc-800 md:w-10/12">
						<div className="relative">
							<AutoFocusPlugin />
							<RichTextPlugin
								contentEditable={
									<div className="">
										<div className="" ref={onRef}>
											<ContentEditable
												...
												className="ContentEditable__root relative block h-[calc(100vh-192px)] overflow-auto px-8 py-4 focus:outline-none"
											/>
										</div>
									</div>
								}
              ...
              <YouTubePlugin /> */}
				...
				<div className="col-span-3 hidden h-full overflow-y-auto bg-white dark:bg-zinc-800 p-4 md:block">
