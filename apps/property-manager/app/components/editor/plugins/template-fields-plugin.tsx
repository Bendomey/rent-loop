...
const TEMPLATE_FIELDS = [
	...
	{ label: 'Tenant ID Type', value: 'TenantIDType' },
	{ label: 'Tenant ID Number', value: 'TenantIDNumber' },
	{ label: 'Tenant Date of Birth', value: 'TenantDateOfBirth' },
	...
	{ label: 'Property Region', value: 'PropertyRegion' },
	{ label: 'Property GPS Address', value: 'PropertyGPSAddress' },
	{ label: 'Unit Number', value: 'UnitNumber' },
	{ label: 'Unit Type', value: 'UnitType' },

	{ label: 'Application Code', value: 'ApplicationCode' },
