...
const unitTypes = [
    {
        ...
        name: 'Apartment',
        description: 'Multi-room unit in a shared building, with separate living and sleeping areas.',
        icon: Building2,
    },
    {
        type: 'HOUSE' as const,
        name: 'House',
        description: 'Standalone building with its own entrance, yard, or compound.',
        icon: Home,
    },
    {
        ...
        mutate(
            ...
            },
            {
                ...
                onSuccess: () => {
                    ...
                    setTimeout(() => {
                        void navigate(
                            `/properties/${property_id}/assets/units/${unit?.id}`,
                        )
                    }, 500)
                },
            },
        ...
        <Form {...rhfMethods}>
            ...
            >
                ...
                <div className="mt-10 flex items-center justify-end space-x-5">
                    <Link
                        to={`/properties/${property_id}/assets/units/${unit?.id}`}
                    >
                        <Button
                            type="button"
                            size="sm"
