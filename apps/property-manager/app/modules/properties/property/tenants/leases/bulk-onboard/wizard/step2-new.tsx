...
export type Step2NewValues = z.infer<typeof Schema>

interface Step2NewProps {
	initialValues?: Partial<Step2NewValues>
	onSave: (values: Step2NewValues) => void
	onBack: () => void
	onCancel: () => void
}

export function WizardStep2New({
	initialValues,
	onSave,
	onBack,
	onCancel,
}: Step2NewProps) {
	const form = useForm<Step2NewValues>({
