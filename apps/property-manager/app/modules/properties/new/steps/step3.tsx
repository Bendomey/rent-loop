  ...
  return (
    <main className="mx-auto mb-5 space-y-8 md:max-w-2/3">
      <div className="space-y-2">
        ...
        <TypographyMuted>Review all information below. Edit any step to make changes before submitting.</TypographyMuted>
      </div>
        ...
        <div className="rounded-md border p-4">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-zinc-600 mt-1">{data.type ?? '—'} · {data.status ?? '—'}</p>
            </div>
            <div>
      ...
      <div className="mt-6 flex items-center justify-end space-x-4">
        ...
        <Button onClick={onSubmit} size="lg" variant="default" className="bg-rose-600 hover:bg-rose-700">
          Submit
        </Button>
      </div>
    </main>
